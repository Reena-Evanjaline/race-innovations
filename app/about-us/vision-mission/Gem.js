...
function Gem() {
  ...
  return (
    <>
      ...
      >
      <p>
      In today’s competitive landscape, automotive and transportation companies must transform operations through smarter technology adoption, cost optimization, and strategic innovation.
      RACE delivers cutting-edge business intelligence, automotive consulting, and transportation solutions to drive sustainable growth. Powered by our GEM philosophy, we ensure smarter decision-making, effective execution, and continuous value creation for our clients
      </p>
      </motion.div>

      {/* Accordion Section */}
      <motion.div
        className="container mt-1" style={{marginBottom:"100px"}}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.2 }}
        variants={fadeInUpVariants}
