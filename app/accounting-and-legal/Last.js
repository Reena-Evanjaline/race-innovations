      ...
      >
        ...
        <div className="row">
          <div className="col-md-4" style={{ fontSize:"18px" , textAlign:"justify" }}>
            <ul>
              <li className="">Corporate tax</li>
              <li className="">Customs duties</li>
              <li className="">Employee incentives</li>
              <li className="">Employment tax</li>
              <li className="">Deportee tax & Employee advice</li>
              <li className="">International tax planning</li>
            </ul>
          </div>
          <div className="col-md-4 mt-1" style={{ fontSize:"18px" , textAlign:"justify"}}>
            <ul>
              <li className="">Personal tax, asset protection & trust planning</li>
              <li className="">Property tax</li>
              <li className="">Tax preparation & Compliance</li>
              <li className="">Transaction support</li>
              <li className="">Transfer pricing</li>
              <li className="">VAT & Indirect Taxes</li>
            </ul>
          </div>
